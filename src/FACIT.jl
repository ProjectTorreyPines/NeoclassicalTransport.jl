...
Base.@kwdef mutable struct FACITinput
    ...
    JV::Union{Vector{Float64},Missing} = missing
...
function FACITinput(
    ...
    JV::Union{Vector{Float64},Missing} = missing, dpsidx::Union{Vector{Float64},Missing}, fsaout::Bool = true, full_geom::Bool = false, fH::Float64 = 0.0,
